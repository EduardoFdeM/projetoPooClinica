...
public class Usuario {
  ...
  public Usuario(int id, String nome, String email, String cpf, String celular, String tipo, LocalDateTime createdAt,
  ...
  // Setter para String da data de nascimento
  public void setDataNascimentoFromString(String dataNascimentoString) {
    if (dataNascimentoString != null && !dataNascimentoString.isEmpty()) {
      ...
      try {
        ...
        System.err.println("Formato de data de nascimento inválido: " + dataNascimentoString);
